...
const sentences = [
...

  {
    ...
    text: (
      <>
        C'est le deuxième jour de Michelle
        <br />
...

  {
    ...
    text: (
      <>
        ...
        <br />
        il y a six fenêtres et deux portes.
      </>
    ),
  },
...

  {
    ...
    text: (
      <>
        Il y a aussi beaucoup de crayons
        <br />
 ...
 <header
      ...
      >
        ...
        <span className="number-of-q">7</span> Vrai (✔️ ) ou faux ( ✖️) ?
      </header>
