...
const Page5_Q1_CleanAudio = () => {
  ...
  const questions = {
    a: "Dans ma maison, il y a deux",
    b: "C’est la pièce où ma mère fait la cuisine,",
    c: "Ce sont les pièces où nous dormons,",
    d: "Dans ma maison, nous mangeons dans",
    e: "C’est le lieu où mon père gare la voiture,",
    f: "Dans ma maison, il y a une télé dans",
    g: "C’est un endroit qui n’est pas dans la maison",
  ...
  return (
    <div className="page-wrapper2 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span  style={{ backgroundColor: "#5e74b7" }} className="ex-A">C</span> <span style={{color:"black"}} className="number-of-q">2</span>Complète la description avec les
mots de l’exercice 1.</header>
