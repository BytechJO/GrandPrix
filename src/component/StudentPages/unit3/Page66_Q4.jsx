...
import img1 from "../../../assets/unite3pages/svg/Page66Q4.png"
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "C'est le stylo de ta soeur ",
    b: "C'est lordinateur portable de mon cousin ",
    c: "C'est le sac à dos de mon oncle ",
    d: "C'est le crayon de mon pere ",
    e: "C'est le gomme de mon ami ",
    f: "C'est le cahier de ma tante",
  ...
  const questions = {
     a: "livre / mère / notre.",
    b: "ordinateur portable / cousin / mon.",
    c: "sac à dos / oncle / mon.",
    d: "crayon / père / mon.",
    e: "gomme / ami / mon.",
    f: "cahier / tante / ta.",
  };
  ...
  return (
    <div className="page-wrapper2 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span  style={{ backgroundColor: "#a4dce7", color:"#5e74b7" }} className="ex-A">Grammaire</span> <span style={{color:"black"}} className="number-of-q">4</span> Écris une phrase</header>
  
      {/* ✅ QUESTIONS */}
      <div className="page5Q3" style={{ marginLeft: "43%" }}>
          <img style={{width:"30%", height:"20%"}} src={img1} alt="" />
