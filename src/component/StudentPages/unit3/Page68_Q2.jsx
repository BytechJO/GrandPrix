...
const Page5_Q1_CleanAudio = () => {
  ...
  return (
    <div className="page-wrapper1 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span  style={{ backgroundColor: "#a4dce7", color:"#5e74b7" }} className="ex-A">DELF</span> <span style={{color:"black"}} className="number-of-q">1</span>
        Lis le petit message et réponds aux questions. <br />
Chaque réponse correcte vaut 3 points.
        </header>
      ...
      <div className="qcm-container">
        <div className="qcm-column">
          <p className="question-title">Pourquoi Alice invite Chloé ?</p>
