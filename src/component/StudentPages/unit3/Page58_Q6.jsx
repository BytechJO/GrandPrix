...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "C’est un appartement qui comporte un salon, unecuisine séparée, une chambre et une salle de bain.",
  };
  ...
  return (
    <div className="page-wrapper2 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span  style={{ backgroundColor: "#5e74b7" }} className="ex-A">C</span> <span style={{color:"black"}} className="number-of-q">6</span> Qu’est-ce que veut dire « T2 » ?</header>
