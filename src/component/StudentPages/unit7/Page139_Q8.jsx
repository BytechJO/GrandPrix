...
const sentences = [
  { id: "a", text: "Le Parkour est seulement un sport." },

  { id: "b", text: (<>Les gens utilisent leur corps <br /> pour aller d'un point à un autre <br /> sans s’arrêter.</>) },

  { id: "c", text: (<>Au début, le Parkour était un <br /> entrainement militaire.</>) },

  { id: "d", text: (<> En 1980, c'est devenu un loisir ou une <br /> discipline sportive.</>) },

  { id: "e", text: (<>Ne pratique pas le Parkour si <br /> tu veux être en forme.</>) },
  { id: "f", text: "Ce sport améliore la coordination." },
  { id: "g", text: "Le Parcour est facile à pratiquer." },
  { id: "h", text: (<>Tu as besoin d'une semaine seulement <br /> pour devenir un spécialiste.</>) },


];


    const correctAnswers = ["b", "c","f"];
