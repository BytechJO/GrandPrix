...
const Page5_Q2_SAppeler = () => {
  ...
  // ================= QUESTIONS =================
 const questions = {
  a: { label: "a-", text: "Je ____(se lever) à 6 heures." },
  b: { label: "b-", text: "Nous ____ (faire) du skateboard." },
  c: { label: "c-", text: "Est-ce que vous ____ (se coucher) tard ?" },
  d: { label: "d-", text: "Mes parents ____ (s’habiller) rapidement." },
  e: { label: "e-", text: "Est-ce que tu ____ (faire) tes devoirs ?" },
  f: { label: "f-", text: "Nous ____ (prendre) notre petit-déjeuner ensemble." },
