...
const Page5_Q2_SAppeler = () => {
 ...
 const captions = [
  ...
  const questions = {
    a: "Il ____ (avoir / visiter) une chute d’eau.",
    b: "Nous ____ (avoir / explorer) un parc national.",
    c: "Ils ____(avoir / loger) à l’hôtel. ",
    d: "Est-ce que tu ____ avoir / nager) dans le Lagon Bleu ?",
    e: "Elle ____ (être / aller) observer les baleines.",
    f: "Est-ce que vous ____ (avoir / voir) une aurore boréale ?",
