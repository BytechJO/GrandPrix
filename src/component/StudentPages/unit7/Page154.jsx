...
import page_1 from "../../../assets/unite7pages/154.png"
      ...
      {/* زر الصوت الأول */}
        ...
        <div
            className="Click -icon-CD-page5 hover:scale-110 transition"
              style={{ overflow: "visible" , position:"absolute",top:"12.0%",left:"76.9%"  }}
            >
              <svg
                width="20"
                height="20"
        ...
        <div
            className="Click -icon-CD-page5 hover:scale-110 transition"
              style={{ overflow: "visible" , position:"absolute",top:"45.5%",left:"33.5%"  }}
            >
              <svg
                width="20"
                height="20"
        ...
        <div
            className="Click -icon-CD-page5 hover:scale-110 transition"
              style={{ overflow: "visible" , position:"absolute",top:"67.5%",left:"47.5%"  }}
            >
              <svg
                width="20"
                height="20"
