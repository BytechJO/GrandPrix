...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
       a: "J'ai visité la tour Eiffel",
    b: "Nous avons longé à l’hôtel",
    c: "Je suis allé à l’école lundi",
    d: "Ils ont dîné avec leur famille",
    e: "Elle s'est habillée rapidement",
    f: "Ma famille et moi avons nagé dans la piscine",
    g: "Est-ce que tu as participé à ce festival ?",

  };

  // === النصوص الأصلية للأسئلة ===
  const questions = {
     a: "Je visite la tour Eiffel.",
    b: "Nous longeons à l’hôtel.",
    c: "Je vais à l’école lundi.",
    d: "Ils dînent avec leur famille.",
    e: "Elle s'habille rapidement.",
    f: "Ma famille et moi nageons dans la piscine.",
    g: "Est-ce que tu participes à ce festival ?",
