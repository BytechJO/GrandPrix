...
import CD6_Pg8_Instruction1_AdultLady from "../../../assets/U8Audio/u8scq1.mp3";
import imgBackground from "../../../assets/unit1/sectionD/P167 1.svg";
...
/* 🔴 القائمة */
const numbersList = [
  { id: "a", label: "Un mot de passe" },
  { id: "b", label: "Télécharger" },
  { id: "c", label: "Un site" },
  { id: "d", label: "Cliquer" },
  { id: "e", label: "Un navigateur" },
  { id: "f", label: "Apparaître" },
  { id: "g", label: "Un virus" },
  { id: "h", label: "Un nom d'utilisateur" },
...
const inputPositions = [
  { id: 0, className: "input-page167-0" },
  { id: 1, className: "input-page167-1" },
  { id: 2, className: "input-page167-2" },
  { id: 3, className: "input-page167-3" },
  { id: 4, className: "input-page167-4" },
  { id: 5, className: "input-page167-5" },
  { id: 6, className: "input-page167-6" },
  { id: 7, className: "input-page167-7" },
...
const captions = [
  ...
  { start: 9.95, end: 14.57, text: "Section C, l'Internet. Exercice 1." },
  { start: 14.57, end: 18.47, text: "Écoute, répète et place dans l'ordre." },
  { start: 46.02, end: 47.52, text: "Utilisateur." },
        ...
        <div className="image-container31">
          ...
          {inputPositions.map((pos) => (
            <input
              ...
              style={{ width: "7%", height: "7%", backgroundColor: "#9ecddf",border:"none" }}
            />
          ))}
        </div>
      </div>
