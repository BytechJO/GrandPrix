...
const sentences = [
  { id: "a", text: (<>En utilisant Internet, tu peux devenir <br /> dépendant.</>) },

  { id: "b", text: (<>Internet ne permet pas de communiquer <br /> avec les autres.</>) },

  { id: "c", text: (<>Ce texte donne des conseils pour bien <br /> utiliser Internet.</>) },

  { id: "d", text: (<> Tu dois choisir un mot de passe facile.</>) },

  { id: "e", text: (<>Tu peux aller sur des sites interdits.</>) },
  { id: "f", text: (<>Tu ne dois pas donner trop <br /> d'informations personnelles.</>) },
