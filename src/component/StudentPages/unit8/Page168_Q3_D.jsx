...
COMPRÉHENSION DE L’ORAL.     </header>
      ...
      <div className="qcm-container">
        <div className="qcm-column">
          <p className="question-title">d-Qu’est-ce que Monique fait sur Internet ?</p>
          <label className={getLabelClass("patric")}>
            <input
              ...
              disabled={!!score}
            />
            Elle écoute de la musique, elle regarde des films, elle chatte avec ses amis, elle <br />
télécharge des documents.
          ...
          <label className={getLabelClass("pierre")}>
            <input
              ...
              disabled={!!score}
            />
          Elle écoute de la musique, elle chatte avec ses amis, elle télécharge des documents.
          </label>
          <label className={getLabelClass("pol")}>
            <input
              ...
              disabled={!!score}
            />
 Elle écoute de la musique, elle regarde des films, elle chatte avec ses amis.          </label>
        </div>
      </div>
