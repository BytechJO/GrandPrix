...
const sentences = [
  { id: "a", text: (<>La technologie occupe une grande place <br /> dans nos vies.</>) },

  { id: "b", text: (<>Les gens suivent la vie de leurs amis <br /> grâce à Instagram.</>) },

  { id: "c", text: (<>Les gens jouent au football dehors au <br /> lieu de jouer sur une console.</>) },

  { id: "d", text: (<> De nos jours, les gens peuvent vivre <br /> sans aucun moyen de communication.</>) },

  { id: "e", text: (<>Les livres sont les seules sources <br /> de connaissances.</>) },
  { id: "f", text: (<>Peut-être que nos vies seraient <br /> plus facile sans Internet.</>) },
