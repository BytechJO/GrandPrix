...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
       a: "qu'est-ce que tu portes aujourd'hui ? ",
    b: "qu'est-ce que tu fais aujourd'hui ?",
    c: "quelle est ta saison préférée ?",
    d: "où sont-ils ?",
    e: "quel temps fait-il",
    f: "quelle est ta couleur préférée ",
    g: "qu'est-ce que tu aimes faire",

  };

  // === النصوص الأصلية للأسئلة ===
  const questions = {
     a: "Je porte une jupe bleue avec un pull gris et des chaussures bleues.",
    b: "Nous jouons au hockey sur glace.",
    c: "Ma saison préférée est le printemps.",
    d: "Ils sont à Rome.",
    e: "Il y a du vent et il neige.",
    f: "Ma couleur préférée est le rouge.",
    g: "J’aime jouer au tennis.",
  ...
  return (
    <div className="page-wrapper2 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span style={{ backgroundColor: "#d7a965", color: "#white" }} className="ex-A">Grammaire</span>
        <span style={{ color: "black" }} className="number-of-q">2</span>
Écris les questions qui correspondent.  </header>
      {/* ✅ QUESTIONS */}
