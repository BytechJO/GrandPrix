...
import img1 from "../../../assets/unite2pages/svg/P125 1.svg";
...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "Ce sont : 64, 91, 15-29, 12, 46, 90.",
    b: "Ce sont : le football, le tennis, le basket, le golf, le volley, le hockey sur glace, le judo, le ski",
    c: "46 pour cent de la population pratique régulièrement un sport.",
    d: "Le nombre de femmes membres d’un club sportif a augmenté.",
    e: "Oui, les jeux vidéo en équipe sont reconnus en France.",
    f: "Le gouvernement français a créé une Académie e-Sport à Nantes.",

  };

  // === النصوص الأصلية للأسئلة ===
const questions = {
  a: "Dis tous les chiffres indiqués dans le rapport.",
  b: "Quels sont les sports les plus populaires en France ?",
  c: "Quel pourcentage de la population pratique régulièrement un sport ?",
  d: "Que se passe-t-il depuis 2011 ?",
  e:"Est-ce que les jeux vidéo en équipe sont reconnus en France ?",
  f:"Qu’est-ce que le gouvernement français a créé ?",
