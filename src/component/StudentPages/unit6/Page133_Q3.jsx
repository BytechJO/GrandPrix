...
const Page5_Q1_CleanAudio = () => {
    ...
    return (
      ...
      >
        ...
        <span style={{ color: "black" }} className="number-of-q">c</span>
COMPRÉHENSION DE L’ORAL.     </header>
            ...
            <div className="qcm-container">
                <div className="qcm-column">
                    <p className="question-title">c-À quelle heure a-t-il son cours de basket ? </p>
