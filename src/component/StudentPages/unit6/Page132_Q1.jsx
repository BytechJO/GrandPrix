...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
       a: "quelle température fait-il ? ",
    b: "quel est ton sport préféré ?",
    c: "as-tu un vêtement préféré ?",
    d: "où es-tu ?",
  ...
  const questions = {
     a: "il / température / fait / - / quelle ?",
    b: "préféré / sport / est / quel / ton ?",
    c: "vêtement / - / as / préféré / un / tu ?",
    d: "- / tu / où / es ?",
    e: "heure / - / il / quelle / est ?",
...
Écris les questions dans le bon ordre.</header>
      {/* ✅ QUESTIONS */}
