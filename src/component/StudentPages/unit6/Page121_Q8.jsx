...
const sentences = [
  { id: "a", text: "Ces textes parlent des quatre saisons." },

  { id: "b", text: (<>L’automne est la saison <br /> préférée d’Henri.</>) },

  { id: "c", text: (<>Lilly pense que l’automne <br /> est une saison magique.</>) },

  { id: "d", text: (<>La famille Roux aime le printemps.</>) },

  { id: "e", text: (<>L’automne est la saison des <br /> récoltes et des feuilles vertes.</>) },
  { id: "f", text: "En été, les journées sont chaudes." },

  { id: "g", text: "Tout devient blanc en automne." },
  { id: "h", text:(<>Au printemps, la nature se <br /> réveille de l’hiver.</>) },
