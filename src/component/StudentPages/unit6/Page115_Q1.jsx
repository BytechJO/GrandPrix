...
import imgBackground from "../../../assets/unit1/sectionD/P115Q1.svg";
...
const numbersList = [
  { id: "a", label: "Il pleut." },
  { id: "b", label: "Il y a du vent." },
  { id: "c", label: "Il neige." },
  { id: "d", label: "Il fait chaud." },
  { id: "e", label: "Il y a du soleil." },
  { id: "f", label: "Il fait mauvais." },
  { id: "g", label: "Il fait beau." },
  { id: "h", label: "Il fait froid." },
...
const inputPositions = [
  { id: 0, className: "input-page115-0" },
  { id: 1, className: "input-page115-1" },
  { id: 2, className: "input-page115-2" },
  { id: 3, className: "input-page115-3" },
  { id: 4, className: "input-page115-4" },
  { id: 5, className: "input-page115-5" },
  { id: 6, className: "input-page115-6" },
  { id: 7, className: "input-page115-7" },
        ...
        <div className="image-container31">
          ...
          {inputPositions.map((pos) => (
            <input
              ...
              style={{ width: "5%", height: "5%", backgroundColor: "white", border:"green solid 2px" }}
            />
          ))}
        </div>
      </div>
