...
const Page5_Q1_CleanAudio = () => {
    ...
    const checkAnswer = () => {
        ...
        setAnswerStatus(status); // ⭐ الإضافة الأساسية
...
Écris les mots qui conviennent.  </header>
                    ...
                    <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
                        <div className="dialogue-text space-y-1">
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Il porte</span>
                                <input
                                    type="text"
                                    value={inputs[0] || ""}
                                ...
                                <span className="text">tous les jours.</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Quand il fait froid, je porte une</span>
                                <input
                                    type="text"
                                    value={inputs[1] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Il y a du soleil, où sont mes</span>
                                <input
                                    type="text"
                                    value={inputs[2] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Elle porte</span>
                                <br />
                                <input
                                    type="text"
                                    value={inputs[5] || ""}
                                    ...
                                    style={{
                                        ...
                                        backgroundColor:
                                            answerStatus[5] === true
                                                ? "#d4f8d4"   // أخضر فاتح
                                                : answerStatus[5] === false
                                                    ? "#f8d4d4"   // أحمر فاتح
                                                    : "transparent",
                                    }}
                                />

                                <span className="text">élégante.</span>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Combien coûtent ces </span>
                                <input
                                    type="text"
                                    value={inputs[6] || ""}
