...
const Page_Find_Pairs = () => {
  ...
  const partA = [
    { id: "a", text: "être en forme" },
    { id: "b", text: "être en bonne santé" },
    { id: "c", text: "quelques conseils" },
    { id: "d", text: "de légumes et de fruits" },
    { id: "e", text: "suivre ces recommandations" },
  ];

  // النصف الثاني (إكمال الجمل)
  const partB = [
    { id: "1", text: "to follow the recommendations" },
    { id: "2", text: "to be in a good health" },
    { id: "3", text: "vegetables and fruits" },
    { id: "4", text: "to be in a good shape" },
    { id: "5", text: "some advice" },
