...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "il y a des frises dans le frigo",
    b: "il y a du beurre pour mes tartines",
    c: "il n'y a pas des bananes dans le gâteau",
    d: "Il n'y a pas des tomates et des pommes de terre",
    e: "il n'y a pas du poulet dans le frigo",
    f: "il y a du café",
    g: "il y a de la viande",

  };

  // === النصوص الأصلية للأسئلة ===
  const questions = {
    a: "Y a-t-il des fraises dans le frigo ? Oui,",
    b: "Est-ce qu’il y a du beurre pour mes tartines ? Oui,",
    c: "Est-ce qu’il y a des bananes dans le gâteau ? Non,",
    d: "Est-ce qu’il y a des tomates et des pommes de terre ? Non,",
    e: "Y a-t-il du poulet dans le frigo ? Non,",
    f: "Est-ce qu’il y a du café ? Oui,",
    g: "Est-qu’il y a de la viande ? Oui,",
...
const resetExercise = () => {
  ...
  return (
      ...
      >
       ...
       Réponds aux questions par des phrases complètes. <br /> Utilise « Il y a » ou « Il n’y a pas ».
      </header>
