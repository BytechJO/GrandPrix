...
import img1 from "../../../assets/unite5pages/SVG/P98.svg";
...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "Léo mange une pomme",
    b: "Non, elle prend des pommes de terre avec de la viande, puis un gâteau",
    c: "Claire mange un gâteau",
    d: "Louis prend un hamburger et des frites, et après, des fraises.",
    e: "Non, il ne mange pas sainement",
    f: "Le conseil est que les gens doivent prendre cinq portions de fruits et de légumes par jour. Moins de chips, de gâteaux et de bonbons.",
...
const questions = {
  a: "Quel fruit mange Léo ?",
  b: "Est-ce que Claire mange seulement de la viande ?",
  c: "Est-ce que Claire mange un gâteau ou un chou ?",
  d: "Qu’est-ce que Louis prend au dîner ?",
  e:"Est-ce qu’il mange sainement ?",
  f:"Quel est le conseil du médecin ?",
...
style={{ ...getInputStyle(key), width: "72%" }}
