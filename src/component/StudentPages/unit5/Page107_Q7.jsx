...
const sentences = [
  { id: "a", text: "Nicolette n'a pas aimé le dîner." },

  { id: "b", text: (<>La nourriture était délicieuse.</>) },

  { id: "c", text: "Le serveur n’était pas attentif." },

  { id: "d", text: (<> Nicolette aime toujours les légumes.</>) },

  { id: "e", text: "Le café était trop sucré." },
  { id: "f", text: "La viande était bonne." },
