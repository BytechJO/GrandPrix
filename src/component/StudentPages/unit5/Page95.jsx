...
import page_1 from "../../../assets/unite5pages/95.png"
      ...
      {/* زر الصوت الأول */}
        ...
        <div
            className="Click -icon-CD-page5 hover:scale-110 transition"
              style={{ overflow: "visible" , position:"absolute",top:"72.9%",left:"36.0%"  }}
            >
              <svg
                width="20"
                height="20"
        ...
        <div
            className="Click -icon-CD-page5 hover:scale-110 transition"
              style={{ overflow: "visible" , position:"absolute",top:"52.3%",left:"89.0%"  }}
            >
              <svg
                width="20"
                height="20"
