...
import img1 from "../../../assets/unite2pages/svg/P95Q9.svg";
...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "Ils ne prennent pas du saumon.",
    b: "Ils prennent des croissants.",
    c: "Ils prennent des céréales.",
    d: "Ils ne prennent pas de frites.",
    e: "Ils ne prennent pas de steak.",
    f: "Ils prennent des tartines.",
    g: "Ils prennent du thé.",
