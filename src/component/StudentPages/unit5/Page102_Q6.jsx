...
const sentences = [
  { id: "a", text: "Ils vont au café." },

  { id: "b", text: (<>Antoine s'assoit à côté de <br />la mère de Camille.</>) },

  { id: "c", text: "Il prend de l’eau minérale." },

  { id: "d", text: (<> Pour commencer, il y a du potage <br /> aux légumes.</>) },

  { id: "e", text: "Il y a du poisson et du poulet." },
  { id: "f", text: "Le père mange de la viande." },

  { id: "g", text: "Antoine mange du poisson." },
  { id: "h", text: "Comme dessert, il y a des fruits." },

  {
    id: "i",
    text: (
      <>
       Antoine mange des raisins.
      </>
    ),
  },
