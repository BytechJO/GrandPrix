...
const Page5_Q2_SAppeler = () => {
 ...
 const captions = [
  ...
  const questions = {
    a: "Qu’est-ce que tu ____ (prendre) comme boisson ?",
    b: "Est-ce que tes amis ____ (prendre) le dîner à la maison ?",
    c: "Est-ce que tu ____ (préférer) le poulet ou la viande ?",
    d: "Est-ce que ton père ____ (manger) des bananes ?",
    e: "Vous ____ (préférer) un dessert ou un café ?",
    f: "Nous ____ (manger) ensemble.",
    g: "Marie et Pierre____(prendre) de la viande avec des pommes de terre comme plat principal.",
    h: "À quelle heure vous ____ (prendre) votre goûter ?",
