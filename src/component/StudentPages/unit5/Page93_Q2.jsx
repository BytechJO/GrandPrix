...
const correctAnswers = {
  a: true, // le salon (مذكر)
  b: false,  // la salle de bains (مؤنث)
  c: true, // la mère (مؤنث)
  d: true,// le garage (مذكر)
  e: false, // un lit (مذكر)
  f: false,  // une porte (مؤنث)
  g: true, // une fenêtre (مؤنث)
  h: false, // un homme (مذكر)
  i: false, // la salle à manger (مؤنث)
  j: false, // le cinéma (مذكر)
  k: false, // le cinéma (مذكر)
  l: false, // le cinéma (مذكر)
  m: false, // le cinéma (مذكر)
  n: true, // le cinéma (مذكر)
  o: false, // le cinéma (مذكر)
  p: false, // le cinéma (مذكر)
};
...
const Page17Q4 = () => {
  ...
  { id: "a", text: "Du café" },
  { id: "b", text: "Du beurre" },
  { id: "c", text: "Du jus (d’orange)" },
  { id: "d", text: "Du lait" },
  { id: "e", text: "Du pain" },
  { id: "f", text: "Du sucre" },
  { id: "g", text: "Du chocolat chaud" },
  { id: "h", text: "Du miel" },
  { id: "i", text: "Des céréales" },
  { id: "j", text: "Des croissants" },
  { id: "k", text: "Des fruits" },
  { id: "l", text: "Des toasts" },
  { id: "m", text: "Des tartines" },
  { id: "n", text: "Du thé" },
  { id: "o", text: "Un oeuf à la coque" },
  { id: "p", text: "De la confiture" },
  ];
