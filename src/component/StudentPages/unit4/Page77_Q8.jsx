...
const sentences = [
  { id: "a", text: (<> Marseille est « un endroit où <br /> le monde se rencontre », <br />  parce qu’il y a beaucoup de  transports.</>) },

  { id: "b", text: (<> Les principaux sites touristiques <br /> de Marseille sont Notre-Dame <br /> de la Garde et le Vieux-Port.</>) },

  { id: "c", text: "l y a beaucoup de champs de tulipes." },

  { id: "d", text: (<> La bouillabaisse, c’est une soupe de <br /> la viande.</>) },

  { id: "e", text: (<> Marseille est le principal port <br /> de la mer Méditerranée.</>) },

  {
    id: "f",
    text: (
      <>
      l n’y a pas d’aéroport à Marseille.
      </>
    ),
  },
