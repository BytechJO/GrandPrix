...
const Page5_Q2_SAppeler = () => {
  ...
  // ================= QUESTIONS =================
 const questions = {
  a: { label: "a-", text: "Il ____à Paris. (habiter)" },
  b: { label: "b-", text: "Je ____ à l’école. (être)" },
  c: { label: "c-", text: "Mon amie ____ à la montagne. (habiter)" },
  d: { label: "d-", text: "J’ ____ quinze ans. (avoir)" },
  e: { label: "e-", text: "Dans mon sac à dos, il ____ de ciseaux. (avoir y)" },
  f: { label: "f-", text: "Ma famille ____ dans un village. (habiter)" },
  g: { label: "g-", text: "Tu ____ prendre le bus. (devoir)" },
