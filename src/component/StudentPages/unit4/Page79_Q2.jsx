...
import img1 from "../../../assets/unite4pages/SVG/79Q2.png";
      ...
      <div className="question-container">
        ...
        <div className="mcq-box">
          ...
          <div className="question-block">
            <p>a Pour jouer au football, on va …</p>
            {["au cinéma", "au stade", "à la banque"].map((opt,index) => (
          ...
          {/* B */}
          <div className="question-block">
            <p>b Pour voir un film, on va …</p>
            {["au cinéma", "à l’hôpital", "au parc"].map((opt,index) => (
              <label key={opt} className="option">
                <input
                  type="radio"
                  name="b"
          ...
          {/* C */}
          <div className="question-block">
            <p>c. Pour trouver une chambre, on va …</p>
            {["au poste de police", "à l’hôtel", "à la banque"].map((opt,index) => (
              <label key={opt} className="option">
                <input
                  type="radio"
                  name="c"
         ...
         {/* D */}
<div className="question-block">
  <p>d.Pour manger un bon repas,on va …</p>
  {[
    "au parc",
    "au supermarché",
    "au restaurant"
...
{/* E */}
<div className="question-block">
  <p>Pour faire les courses, on va …</p>
  {["à l’école", "à la station-service", "au supermarché"].map((opt,index) => (
    <label key={opt} className="option">
      <input
        type="radio"
        name="e"
