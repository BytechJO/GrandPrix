...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
       a: "j’ habite à paris ",
    b: "tu dois tourner à gauche",
    c: "je veux aller au cinéma",
    d: "mon amie habite dans une ferme ",
    e: "est-ce que votre frère habite sur une île",
    f: "tu dois prendre le bus numéro 5 ",
    g: "Ma famille habite à paris ",
    h: "où habite ton frère",
    i: "je vais à l’école en bus ",
    j: "C’est la famille de Daniel",
  };

  // === النصوص الأصلية للأسئلة ===
  const questions = {
     a: "Paris / j’ / à / habite",
    b: "tourner / tu / à / dois / gauche",
    c: "cinéma / je / aller / veux / au.",
    d: "ferme / mon / habite / une / amie / dans.",
    e: "habite / est-ce / une / île / frère / sur / que / votre",
    f: "bus / tu / prendre / 5 / le / dois / numéro.",
    g: "habite / ma / Paris / famille / à.",
    h: "? / habite / frère / où / ton.",
    i: "en / à / je / bus / vais / l’école",
