   ...
   COMPRÉHENSION DES ÉCRITS
      ...
      <div className="qcm-container">
        <div className="qcm-column">
          <p className="question-title">a-De quoi parle cette publicité ?</p>
          ...
          <label className={getLabelClass("pierre")}>
            <input
              ...
              disabled={!!score}
            />
          2- Elle parle d’un nouveau magasin de chaussures.
          </label>
          <label className={getLabelClass("pol")}>
            <input
              ...
              disabled={!!score}
            />
           3- Elle parle d’un vieux magasin de chaussures.
          </label>
        </div>
      </div>
