...
const MatchingWithCanvas = () => {
  const leftItems = [
    ...
    "As-tu un vêtement préféré ?",
    "Quelle température fait-il ?",
  ];

  const rightItems = [
    "1-Je porte une jupe et un chemisier",
    "2-Il fait 23 °C",
    "3-Mon vêtement préféré est le jean.",
    "4-L’été est ma saison préférée.",
    "5-Il est 4 heures.",
    "6-Il y a du vent aujourd’hui.",
    "7-Je joue au basket.",
  ];
