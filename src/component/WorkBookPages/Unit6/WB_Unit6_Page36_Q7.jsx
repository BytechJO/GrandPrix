...
const Page5_Q2_SAppeler = () => {
  ...
  const questions = {
    a: "Le samedi, mon père joue____golf.",
    b: "Est-ce que vous aimez jouer ____volley ?",
    c: "Mon frère et moi jouons____jeux vidéo",
    d: "Je n’aime pas jouer____échecs.",
    e: "Est-ce que ton ami joue____basket ?",
    f: "Mes enfants jouent____ hockey sur glace.",
    g: "Est-ce que tu joues____billes ?",
