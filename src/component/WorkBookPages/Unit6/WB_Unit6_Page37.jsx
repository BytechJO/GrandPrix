...
import page_1 from "../../../assets/workpages/37.png"
...
const WB_Unit1_Page1 = ({openPopup}) => {
 ...
 {/* زر التمرين 2 */}
      ...
      style={{ overflow: "visible" , position:"absolute",top:"26.7%",left:"29.5%"  }}
      >
        <svg
          width="22"
          height="22"
      ...
      <div
        className="wb-unit1-p3-q2 hover:scale-110 transition"
      style={{ overflow: "visible" , position:"absolute",top:"60.5%",left:"46.5%"  }}
      >
        <svg
          width="22"
          height="22"
