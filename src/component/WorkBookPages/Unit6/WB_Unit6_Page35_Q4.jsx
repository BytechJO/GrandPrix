    ...
    return (
        <div className="page-wrapper1 flex flex-col items-center justify-start gap-8 p-4">
            ...
            >
                ...
                Regarde la carte et complète avec « au nord (de) », « au sud (de) », « à l’est <br />
                (de) » et « à l’ouest (de) ».
            </header>
                    ...
                    <div className="page28q4-dialogue-exercise w-full bg-white p-8 rounded-xl">
                        <div className="page28q4-dialogue-text space-y-6">
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Toulouse est</span>
                                <input
                                    type="text"
                                    value={inputs[0] || ""}
                                ...
                                />
                                <span className="text">la France.</span>
                            </div>

                            {/* b */}
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold min-w-[40px]">b</span>
                                <span className="text">Nantes est</span>
                                <input
                                    type="text"
                                    value={inputs[1] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Marseille est</span>
                                <input
                                    type="text"
                                    value={inputs[2] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Lyon est</span>
                                <input
                                    type="text"
                                    value={inputs[3] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Caen est</span>
                                <input
                                    type="text"
                                    value={inputs[4] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Limoges est</span>
                                <input
                                    type="text"
                                    value={inputs[5] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Nice est</span>
                                <input
                                    type="text"
                                    value={inputs[6] || ""}
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Paris est</span>
                                <input
                                    type="text"
                                    value={inputs[7] || ""}
