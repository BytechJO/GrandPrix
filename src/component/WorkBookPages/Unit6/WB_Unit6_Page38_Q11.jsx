...
const Page5_Q2_SAppeler = () => {
  ...
  const questions = {
    a: "Mes parents____de montre. (ne pas, porter).",
    b: "Ma soeur ____toujours des chaussures à talon. (porter)",
    c: "Est-ce que tu____ces jupes ? (essayer)",
    d: "Aujourd’hui, nous____le même pull. (porter)",
    e: "Où est Ruby ? -Elle____un jean. (essayer)",
    f: "Ma tante____ de foulards. (ne pas, porter)",
    g: "Ma cousine a un sac à main gris. Elle le____chaque jour. (porter)",
    h: "Je____un uniforme à l’école. (porter)",
 ...
 <div className="page-wrapper2 flex flex-col items-center justify-start gap-8 p-4">
     <header
            ...
            >
             ...
             Complète les phrases avec les verbes entre parenthèses.
            </header>
