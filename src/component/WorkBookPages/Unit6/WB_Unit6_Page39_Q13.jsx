    ...
    return (
        <div className="page-wrapper1 flex flex-col items-center justify-start gap-8 p-4">
            ...
            >
                ...
                <span style={{ color: "black" }} className="number-of-q">13</span>
            ...
            {/* Exercise Container */}
            <div className="page28q4-exercise-container w-full max-w-6xl flex flex-col lg:flex-row gap-2" style={{ justifyContent: "center", marginRight: "5%" }}>
                {/* Dialogue */}
                    ...
                    <div className="page28q4-dialogue-exercise w-full bg-white p-8 rounded-xl">
                        <div className="page28q4-dialogue-text space-y-6">
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">est devant la jupe</span>
                            </div>

                            {/* b */}
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold min-w-[40px]">b</span>
                                <span className="text">Les</span>
                                <input
                                    type="text"
                                    value={inputs[1] || ""}
                                ...
                                />
                                <span className="text">sont à côté du sac à main.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">est derrière la veste.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">est à côté des t-shirts.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">sont devant le jean.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">est à côté des lunettes de soleil.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">est entre les chaussures à talon et le pull.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">est devant le jean.</span>
                            </div>
