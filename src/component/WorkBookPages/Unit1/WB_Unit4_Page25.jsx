...
import page2 from "../../../assets/workpages/25.png";
  ...
  return (
    <div className="relative w-full h-full flex justify-center items-center">
      ...
      <div
        ...
        style={{ overflow: "visible" , position:"absolute",top:"7.0%",left:"54%"  }}
      >
        <svg
          width="22"
          height="22"
      ...
      <div
        className="wb-unit1-p3-q2 hover:scale-110 transition"
        style={{ overflow: "visible" , position:"absolute",top:"43.5%",left:"33.7%"  }}
      >
        <svg
          width="22"
          height="22"
      ...
      <div
        className="wb-unit1-p3-q2 hover:scale-110 transition"
        style={{ overflow: "visible" , position:"absolute",top:"65.5%",left:"59.7%"  }}
      >
        <svg
          width="22"
          height="22"
