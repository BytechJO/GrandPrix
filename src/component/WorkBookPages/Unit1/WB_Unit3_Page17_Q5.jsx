...
const correctAnswers = {
  ...
  h: true, // un homme (مذكر)
  i: false,  // la salle à manger (مؤنث)
  j: true  // le cinéma (مذكر)
};
...
const Page17Q4 = () => {
  ...
  const items = [
    ...
    { id: "b", text: "le garçon" },
    { id: "c", text: "le frère" },
    { id: "d", text: "une chaise" },
    { id: "e", text: "l’appartement" },
    { id: "f", text: "la soeur" },
    { id: "g", text: "l’oncle" },
    { id: "h", text: "un garage" },
    { id: "i", text: "la cuisine" },
    { id: "j", text: "le cousin" }
  ];
  ...
  return (
   ...
   <header
     ...
     Souligne les mots masculins.
      </header>

      <div style={{ fontSize: "18px", color: "#333", marginBottom: "20px", textAlign: "center" }}>
        Exemple : <span style={{ textDecoration: "underline", color: "#5e74b7" }}>le jardin</span>
      </div>
