          ...
          <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
            <div className="dialogue-text space-y-1">
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Le Docteur Compois travaille</span>
                <input
                  type="text"
                  value={inputs[0] || ""}
                ...
                />
                <span className="text">hôpital.</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Mon ami va</span>
                <input
                  type="text"
                  value={inputs[1] || ""}
                  onChange={(e) => handleInputChange(0, e.target.value)}
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">cinéma.</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Le dimanche, nous allons</span>
                <input
                  type="text"
                  value={inputs[2] || ""}
                  onChange={(e) => handleInputChange(0, e.target.value)}
            ...
            hôtel, aujourd’hui
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Nous allons</span>
                <br />
                <input
                  type="text"
                  value={inputs[5] || ""}
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                             <span className="text">marché de poissons.</span>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Lily veux aller </span>
                   <input
                  type="text"
                  value={inputs [6] || ""}
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">grands magasins.</span>
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Nous habitons</span>
                <input
                  type="text"
                  value={inputs [7] || ""}
                  onChange={(e) => handleInputChange(5, e.target.value)}
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">États-Unis.</span>
              </div>
