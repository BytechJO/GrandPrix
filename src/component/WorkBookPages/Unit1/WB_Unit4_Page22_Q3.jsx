...
className="header-title-page1 w-full text-left mb-4"
  style={{ marginLeft: "42%", color:"black",marginTop:"5%",fontSize:"25px", fontWeight:"bold" }}
      >
        <span style={{backgroundColor:"#ce5b66"}} className="ex-A">4</span> <span style={{color:"black"}} className="number-of-q">3</span>Complète les conversations avec la forme correcte du verbe « habiter ».
      </header>
          ...
          <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
            <div className="dialogue-text space-y-1">
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Ray : Est-ce que tes amis</span>
                <input
                  type="text"
                  value={inputs[0] || ""}
                ...
                />
                <span className="text">près de ta maison ?</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                <span className="text">Roi : Non, ils</span>
                <input
                  type="text"
                  value={inputs[1] || ""}
                  onChange={(e) => handleInputChange(0, e.target.value)}
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">près de ma maison.</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Karl : Où </span>
                <input
                  type="text"
                  value={inputs[2] || ""}
                  onChange={(e) => handleInputChange(0, e.target.value)}
