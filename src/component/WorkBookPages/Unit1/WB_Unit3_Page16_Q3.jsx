...
const Page5_Q1_CleanAudio = () => {
  ...
  return (
    ...
    <header
     ...
     Écris quelques phrases sur la famille sur le modèle de l’exercice 2.
      ...
      <div className="qcm-container">
        <div className="qcm-column">
          ...
          <p className="question-title mb-4">Écris</p>
          <textarea
            ...
            placeholder=" Écris quelques phrases sur la famille"
            value={answer}
