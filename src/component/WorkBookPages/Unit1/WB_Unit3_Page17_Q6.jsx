...
const Page17Q4 = () => {
  ...
  return (
    <div className="page-wrapper1 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span className="ex-A" style={{ backgroundColor: "#5e74b7" }}>4</span>
      ...
      <div className="action-buttons-container flex gap-4">
        <button
          ...
          className="try-again-button px-6 py-3 bg-gray-200 hover:bg-gray-300 rounded-lg font-medium transition"
        >
          Recommencer ↻
        </button>
        <button
          onClick={showAnswerFunc}
          className="show-answer-btn px-6 py-3 bg-blue-100 hover:bg-blue-200 text-blue-800 rounded-lg font-medium transition"
        >
          Afficher la réponse
        </button>
        <button
          onClick={checkAnswer}
          className="check-button2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition"
        >
          Vérifier la réponse ✓
        </button>
      </div>
