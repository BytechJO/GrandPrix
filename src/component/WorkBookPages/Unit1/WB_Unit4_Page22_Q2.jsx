...
className="header-title-page1 w-full text-left mb-4"
  style={{ marginLeft: "42%", color:"black",marginTop:"5%",fontSize:"25px", fontWeight:"bold" }}
      >
        <span style={{backgroundColor:"#ce5b66"}} className="ex-A">4</span> <span style={{color:"black"}} className="number-of-q">2</span>Complète avec la forme correcte du verbe « habiter ».
      </header>
          ...
          <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
            <div className="dialogue-text space-y-1">
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Est-ce que tes parents</span>
                <input
                  type="text"
                  value={inputs[0] || ""}
                ...
                />
                <span className="text">dans une ferme ? (habiter)</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Mes cousins</span>
                <input
                  type="text"
                  value={inputs[1] || ""}
                  onChange={(e) => handleInputChange(0, e.target.value)}
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">aux États-Unis, à New York. (habiter)</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <input
                  ...
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">-tu ? (habiter)</span>
                <br />
              </div>
             ...
             à Marseille ? (habiter)
              ...
              <div className="dialogue-line flex items-start">
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                             <span className="text">à Bordeaux. (habiter)</span>
              ...
              <div className="dialogue-line flex items-start">
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">-vous ? (habiter)</span>
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Ma famille</span>
                <input
                  type="text"
                  value={inputs [7] || ""}
                  onChange={(e) => handleInputChange(5, e.target.value)}
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">dans un petit village près d’Orange. (habiter)</span>
              </div>
