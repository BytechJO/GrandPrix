          ...
          <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
            <div className="dialogue-text space-y-1">
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">J’aime les technologies modernes, je</span>
                <input
                  type="text"
                  value={inputs[0] || ""}
                ...
                />
                <span className="text">utilise tous les jours.</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Est-ce que tu as fini ton travail ? Non, je ne</span>
                <input
                  type="text"
                  value={inputs[1] || ""}
                  ...
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">ai pas fini.</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Fais-tu tes devoirs ? Oui, je</span>
                <input
                  type="text"
                  value={inputs[2] || ""}
              ...
              <div className="dialogue-line flex items-start">
                ...
                d-
                   ...
                   <span className="text">
               Pierre a téléchargé un nouveau film, nous
                </span>
                         <input
                  type="text"
                  value={inputs[3] || ""}
            ...
            ai lu.
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Est-ce que tu regardes la télé ? Oui, je</span>
                <br />
                <input
                  type="text"
                  value={inputs[5] || ""}
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                             <span className="text">regarde.</span>
