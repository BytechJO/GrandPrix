          ...
          <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
            <div className="dialogue-text space-y-1">
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Les enfants</span>
                <input
                  type="text"
                  value={inputs[0] || ""}
                ...
                />
                <span className="text">(se lever) à six heures pour aller à l’école</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">À quelle heure vous</span>
                <input
                  type="text"
                  value={inputs[1] || ""}
                  ...
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">(se coucher) ?</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Quand il fait très chaud, je</span>
                <input
                  type="text"
                  value={inputs[2] || ""}
                  ...
                  style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">(se doucher) deux fois par jour.</span>
                <br />
              </div>
              ...
              <div className="dialogue-line flex items-start">
               ...
               Marie
                ...
                />
                    <span className="text">
             (s’habiller) rapidement, car elle est en retard.
                </span>
              </div>
              <div className="dialogue-line flex items-start">
                <span className="speaker font-bold  min-w-[80px]">
            ...
            (s’appeler) ?
              ...
              <div className="dialogue-line flex items-start">
                ...
                <span className="text">Ses fils</span>
                <br />
                <input
                  type="text"
                  value={inputs[5] || ""}
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                             <span className="text">(se brosser) les dents avant de se coucher.</span>
              ...
              <div className="dialogue-line flex items-start">
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">(s’habiller) avant le petit-déjeuner.</span>
              </div>
              ...
              <div className="dialogue-line flex items-start">
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">(prendre) mon petit-déjeuner à 7 heures.</span>
              </div>
              <div className="dialogue-line flex items-start">
                <span className="speaker font-bold text-black-900 min-w-[80px]">
                  i-
                </span>
                <span className="text">Les filles</span>
                <input
                  type="text"
                  value={inputs [8] || ""}
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">(se coucher) tôt.</span>
              </div>
              <div className="dialogue-line flex items-start">
                <span className="speaker font-bold text-black-900 min-w-[80px]">
                  j-
                </span>
                <span className="text">Mon petit frère</span>
                <input
                  type="text"
                  value={inputs [9] || ""}
               ...
               style={{borderBottom:"2px solid black ", marginLeft:"5px"}}
                />
                <span className="text">(se brosser) les dents deux fois par jour.</span>
              </div>
