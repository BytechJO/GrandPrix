...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "mark et Roy les utilisent tous les jours.",
    b: "ma mère les a donnés.",
    c: "ma famille le mange.",
    d: "je le lis.",
    e: "est-ce que ton frère les aime ?",
    f: "je l’utilise pour écouter de la musique.",
    g: "elle l’appelle.",
  ...
  const questions = {
    a: "Mark et Roy utilisent les écouteurs sans fils tous les jours.",
    b: "Ma mère a donné ses bijoux.",
    c: "Ma famille mange le gâteau.",
    d: "Je lis ce livre.",
    e: "Est-ce que ton frère aime ces bonbons ?",
    f: "J’utilise Internet pour écouter de la musique.",
    g: "Elle appelle son ami",
  ...
  return (
   ...
   <header
            ...
            >
             ...
             Remplace par les pronoms compléments d’objets <br /> directs qui conviennent.
            </header>
