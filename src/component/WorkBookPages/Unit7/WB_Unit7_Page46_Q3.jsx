...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "le professeur les donne",
    b: "je l’utilise pour faire des photos",
    c: "marc le donne",
    d: "je les fais tous les jours",
    e: "est-ce que tu peux l’ouvrir ?",
    f: "elle les a appelé pour dîner",
    g: "je le prends toujours",
  ...
  const questions = {
    a: "Le professeur donne les cahiers.",
    b: "J’utilise le drone pour faire des photos.",
    c: "Marc donne son cahier.",
    d: "Je fais mes devoirs tous les jours.",
    e: "Est-ce que tu peux ouvrir la fenêtre ?",
    f: "Elle a appelé ses enfants pour dîner.",
    g: "Je prends toujours le train.",
   ...
   {/* Header */}
    <header
            ...
            >
             ...
             Réécris avec le pronom qui convient.
            </header>
