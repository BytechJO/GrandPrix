...
const Page5_Q2_SAppeler = () => {
  ...
  const questions = {
    a: "____journaux aimez-vous lire ?",
    b: "____villes voulez-vous visiter ?",
    c: "____jour sommes-nous aujourd’hui ?",
    d: "____chaussures porte-t-elle ?",
    e: "____type de bijoux cherches-tu ?",
    f: "____âge a-t-il ?",
...
const resetExercise = () => {
 ...
 <header
            ...
            >
             ...
             Complète avec « quel », « quelle », « quels » ou « quelles ».
            </header>
      {/* ✅ QUESTIONS */}
   <div
  className="page5Q5"
