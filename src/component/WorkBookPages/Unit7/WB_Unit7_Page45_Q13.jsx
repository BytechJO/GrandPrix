                    ...
                    <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
                        <div className="dialogue-text space-y-1">
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">(rentrer) à Paris lundi dernier.</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(faire) du sport mercredi dernier ?</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(explorer) le parc national hier.</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">
                                    (prendre) votre dîner ensemble.                </span>
                            </div>
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold  min-w-[80px]">
                                    e-
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(se lever) hier ?</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(mange) beaucoup de fruits en juin.</span>
                            </div>
