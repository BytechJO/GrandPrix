    ...
    return (
        <div className="page-wrapper1 flex flex-col items-center justify-center gap-3 p-4">
            ...
            >
                ...
                <span style={{ color: "black" }} className="number-of-q">10</span>
                    ...
                    <div className="dialogue-exercise w-full bg-white p-8 rounded-xl ">
                        <div className="dialogue-text space-y-1">
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <span className="text">Mon père et moi</span>
                                <input
                                    type="text"
                                    value={inputs[0] || ""}
                                ...
                                />
                                <span className="text">(aller) à la pêche samedi dernier.</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(visiter) Lyon l’année dernière.</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(envoyer) un message à Kara ce matin.</span>
                                <br />
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                />
                                <span className="text">
                                    (aller) aux grands magasins et elle
                                </span>
                                <input
                                    type="text"
                                    value={inputs[4] || ""}
                            ...
                            {/* Ligne 8 */}
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold text-black-900 min-w-[80px]">
                                    f-
                                </span>
                                <span className="text">Elle</span>
                                <br />
                                <input
                                    type="text"
                                    value={inputs[6] || ""}
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(se lever) très tôt.</span>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(ne pas aller) au cinéma hier.</span>
                            </div>
                            ...
                            <div className="dialogue-line flex items-start">
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(voir) ce film hier.</span>
                            </div>
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold text-black-900 min-w-[80px]">
                                    i-
                                </span>
                                <span className="text">À quelle heure tu</span>
                                <input
                                    type="text"
                                    value={inputs[9] || ""}
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(rentrer) à la maison ?</span>
                            </div>
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold text-black-900 min-w-[80px]">
                                    j-
                                ...
                                <input
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(arriver) à Paris hier.</span>
                            </div>
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold text-black-900 min-w-[80px]">
                                    k-
                                </span>
                                <span className="text">Marc</span>
                                <input
                                    type="text"
                                    value={inputs[11] || ""}
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(ne pas, sortir).</span>
                            </div>
                            <div className="dialogue-line flex items-start">
                                <span className="speaker font-bold text-black-900 min-w-[80px]">
                                    j-
                                </span>
                                <span className="text">Ma soeur</span>
                                <input
                                    type="text"
                                    value={inputs[12] || ""}
                                    ...
                                    style={{ borderBottom: "2px solid black ", marginLeft: "5px" }}
                                />
                                <span className="text">(ne pas, faire) ses devoirs</span>
                            </div>
