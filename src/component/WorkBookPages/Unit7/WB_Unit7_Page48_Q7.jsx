...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "Qu’aimez-vous sur ce site ?",
    b: "Que fait-il aujourd’hui ?",
    c: "Que font-elles le dimanche ?",
    d: "Que penses-tu de cette photo ?",
    e: "Que fait-il au village ?",
    f: "Qu’avez-vous acheté dans ce magasin ?",
    g: "Que fais-tu ce soir ?",
  ...
  const questions = {
    a: "ce / qu’ / - / vous / site / aimez / sur ?",
    b: "aujourd’hui / il / que / fait / - / ?",
    c: "font / le / - / dimanche / elles / que ?",
    d: "de / que / cette / penses / - / photo / tu ?",
    e: "au / il / village / - / fait / que ?",
    f: "ce / qu’ / dans / vous / - / magasin / acheté / ? / avez",
    g: "que / ce / - / tu / soir / fais ?",
