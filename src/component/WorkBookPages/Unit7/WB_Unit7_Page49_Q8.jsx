...
const Page5_Q1_CleanAudio = () => {
  ...
  const correctAnswers = {
    a: "Combien de fois par semaine joues-tu au tennis ?",
    b: "Quelle est ta couleur préférée ?",
    c: "Qu’avez-vous acheté dans ce magasin ?",
    d: "À quelle heure te lèves-tu ?",
    e: "Quel jour sommes-nous ?",
    f: "Quelle est ta matière préférée ?",
  ...
  const questions = {
    a: "Je joue au tennis deux fois par semaine.",
    b: "Ma couleur préférée est le jaune.",
    c: "J’ai acheté une jupe rouge dans ce magasin.",
    d: "Je me lève à 6 heures.",
    e: "Aujourd’hui, nous sommes samedi.",
    f: "Ma matière préférée est le français.",
    g: "Il fait chaud.",
