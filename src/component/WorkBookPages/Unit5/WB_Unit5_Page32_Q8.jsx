...
const Page5_Q2_SAppeler = () => {
  ...
  const questions = {
    a: "Il ____ (mange) sainement.",
    b: "Jacques ____ (préférer) le café au lait.",
    c: "Nous ____ (prendre) le goûter ensemble ?",
    d: "Mes amis ____ (ne pas, manger) de beurre.",
    e: "Comme boisson, elle____ (prendre) du jus d’orange.",
    f: "Qu’est-ce que vous____ (prendre) comme plat principal ?",
    g: "Pierre et Georges____ (prendre) des tartines.",
    h: "Nous____ (manger) souvent du poisson.",
    i: "Qu’est-ce que tu____ (préférer), de la viande ou du poulet ?",
  };
