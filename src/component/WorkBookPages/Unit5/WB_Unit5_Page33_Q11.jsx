...
const Page5_Q1_CleanAudio = () => {
  ...
  const questions = {
     a: "Est-ce que vous mangez des fruits ?",
    b: "Est-ce que tes parents mangent des légumes ?",
    c: "Est-ce que tu manges du poisson ?",
    d: "Est-ce que ta soeur/ton frère mange des pâtes ?",
    e: "Est-ce que ta mère mange des tartines ?",
    f: "Est-ce que ton ami boit de l’eau ?",
  };
  ...
  return (
    <div className="page-wrapper2 flex flex-col items-center justify-start gap-8 p-4">
      ...
      >
        <span style={{ backgroundColor: "#d47176", color: "#white" }} className="ex-A">5</span>
        <span style={{ color: "black" }} className="number-of-q">11</span>
     Réponds aux questions. Utilise « trop (de) », « assez (de) », « beaucoup (de) », « peu (de) ». <br />
      ...
      <div className="page5Q3" style={{ marginLeft: "43%" }}>
       ...
       <h1 style={{color:"red"}}>Les réponses sont libres.</h1>
      </div>
