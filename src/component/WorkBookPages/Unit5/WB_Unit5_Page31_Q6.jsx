...
const Page5_Q2_SAppeler = () => {
  ...
  const questions = {
    a: "Qu’est-ce que tu ____ au petit-déjeuner ?",
    b: "Vous ____ un café ou un thé ?",
    c: "Est-ce que Pierre ____ du sucre ?",
    d: "Est-ce que tes parents ____  des céréales ?",
    e: "Nous____  le dîner ensemble ? ",
    f: "Qu’est-ce qu’il____ comme boisson ?",
    g: "Vous____ du poisson ou de la viande ?",
    h: "Est-ce que ton ami____ du lait au petit-déjeuner?",
  };
